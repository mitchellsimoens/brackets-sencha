...
define(function(require) {
    ...
    Sencha.define('Sencha.panel.Preferences', {
        ...
        getTemplate : function() {
            ...
            if (!tpl) {
                tpl = this._template = require('text!templates/preferences/formModal.html');
            }
        ...
        showPreferencesDialog : function() {
            var modalTemplate = this.getTemplate(),
                senchaPrefs   = [],
                groups        = {},
            ...
            $saveButton  .on('click', Sencha.bind(this.savePreferences, this));
            $pathButtons .on('click', Sencha.bind(this.showPathSelector, this));
            $clearButtons.on('click', Sencha.bind(this.clearFieldValue, this));
        }
    });
});
